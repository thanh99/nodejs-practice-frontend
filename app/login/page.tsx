...
export default function LoginPage() {
  ...
  // [SINGLE-SESSION] Bỏ comment để hiển thị banner khi bị kick
  // const [info, setInfo] = useState("");
  // useEffect(() => {
  //   const msg = sessionStorage.getItem("loginMessage");
  //   if (msg) { setInfo(msg); sessionStorage.removeItem("loginMessage"); }
  // }, []);
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-200 w-full max-w-md">
        ...
        {/* [SINGLE-SESSION] Bỏ comment để hiển thị banner vàng */}
        {/* {info && (
